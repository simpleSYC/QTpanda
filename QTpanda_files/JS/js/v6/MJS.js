...
a_geter=i;//parseInt(SRCimg.slice((SRCimg.length)-11,(SRCimg.length)-9));          ova samo za akvos e zeleoto
	...
	SRT_GO=GOTOVAL[0].children[i].children[3].innerHTML+" "+GOTOVAL[0].children[i].children[5].innerHTML;
...
ElemtiZAemail[a_geter]="||"+qti_GO+"*box[ ("+NAZIV+" {typ: "+SRT_GO+" } ) ]";           //// ova de se onadeee
